...
@Database(entities = [Actividad::class, Area::class, Costo::class, Estatus::class, Objetivo::class, Proyecto::class, Usuario::class, Privilegio::class, Rol::class], version = 1)
