...
class ActivityMainHomepageEspectadorAdapterVertical(private val list: MutableList<EventsInMonth>) : RecyclerView.Adapter<ActivityMainHomepageEspectadorViewHolderVertical>() {
