...
class ActivityMainHomepageOrganizadorAdapterVertical(private val list: MutableList<EventsInMonth>) : RecyclerView.Adapter<ActivityMainHomepageEspectadorViewHolderVertical>() {
