...
class ActivityMainHomepageOrganizadorAdapterVertical(private val list: MutableList<EventModel>) : RecyclerView.Adapter<ActivityMainHomepageEspectadorViewHolderVertical>() {
